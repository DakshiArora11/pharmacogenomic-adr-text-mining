...
MODEL_OUT = "models/fusion_model_mlp_viz.pt"
EPOCHS = 40
LR = 1e-3
BATCH_SIZE = 512
...
# Precision-Recall
plt.subplot(1,3,2)
plt.plot(rec, prec, label=f"AP={auprc:.3f}", color="purple")
...
plt.subplot(1,3,3)
plt.hist(preds[y_test==1], bins=30, alpha=0.6, label="Positives")
plt.hist(preds[y_test==0], bins=30, alpha=0.6, label="Negatives")
